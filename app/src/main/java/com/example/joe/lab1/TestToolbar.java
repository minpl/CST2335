...
public class TestToolbar extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Source: https://stackoverflow.com/questions/30978457/how-to-show-snackbar-when-activity-starts
        ...
        snackbarLauncher.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Snackbar.make(parentLayout, "This is a Snackbar message!", Snackbar.LENGTH_LONG)
                        .show();
            }
        });
    }
    ...
    public boolean onOptionsItemSelected(MenuItem menuItem) {
        ...
        switch (menuItem.getItemId()) {
            ...
            case R.id.action_three:
                ...
                final EditText etEnteredMsg = (EditText) rootView.findViewById(R.id.customMessageEditText);
            ...
            case R.id.action_four:
                Toast.makeText(this, "Version 1.0\nBy: Joe Ireland", Toast.LENGTH_LONG)
                        .show();
                break;
        }
